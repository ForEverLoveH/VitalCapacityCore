...
namespace PLADCore
{
    internal class GameRoot
    {
        ...
        static PersonWindowSys PersonWindowSys = new PersonWindowSys ();
        static  LoadingWindowSys LoadingWindowSys = new LoadingWindowSys ();
        static SystemSettingWindowSys SystemSettingWindowSys = new SystemSettingWindowSys();
        static ExportGradeWindowSys ExportGradeWindowSys = new ExportGradeWindowSys();
        static PlatFormSettingWindowSys PlatFormSettingWindowSys = new PlatFormSettingWindowSys ();
        static RunningMachineSettingWindowSys RunningMachineSettingWindowSys = new RunningMachineSettingWindowSys ();
        static RunningTestingWindowSys RunningTestingWindowSys = new RunningTestingWindowSys();
       // static ChooseRoundWindowSys ChooseRoundWindowSys = new ChooseRoundWindowSys();
